//sidebar menu build & selector module v.3.2.2 for bookshop prj
...
const sbItemSel=function(){
			   const sbItems=cnst.d7.querySelectorAll('.sidebarItem'), sbMarkers=cnst.d7.querySelectorAll('.sibarMark'),
